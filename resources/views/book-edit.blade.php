    ...
    <div class="mt-5 w-50">
        ...
        <form action="/book-edit/{{ $book->slug }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{ $book->book_code }}" name="book_code" id="code" class="form-control">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div>
                    ...
                    @if ($book->cover != '')
                        <img src="{{ asset('storage/cover/' . $book->cover) }}" alt="" style="width: 90px">
                    @else
                        <img src="{{ asset('images/not_found.png') }}" alt="" style="width: 90px">
                    @endif
                </div>
            ...
            <div class="mb-3">
                ...
                <select name="categories[]" id="category" class="form-control select-mulltiple" multiple>
