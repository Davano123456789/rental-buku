...
Route::middleware('only_guest')->group(function () {
    ...
    // midlewere biar yang sudah login tidak bisa balik ke halaman login
...
Route::middleware('auth')->group(function () {
    ...
    // middlewere auth  biar tidak bisa masuk ke halaman dahboard dan profile kalau belum login
...
Route::post('book-rent', [BookRentController::class, 'store']);
    ...
    Route::post('pakar-add', [PakarController::class, 'add']);
});
